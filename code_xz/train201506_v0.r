...
result_dt <- train[fecha_dato %in% c('2015-06-28')]
result_dt$fecha_dato <- NULL
result_dt <- result_dt[!duplicated(ncodpers)]

result_dt <- result_dt[,1:23, with = F]

result_dt <- merge(result_dt, june_added_unique, by = "ncodpers")

train <- train[fecha_dato %in% c('2015-01-28', '2015-02-28',
...
result <- result_dt
for(date in c('2015-01-28', '2015-02-28','2015-03-28', '2015-04-28','2015-05-28')){
...
write.csv(result, file = "../data/train201506_v0.csv", row.names = F)
